<template>
	<div>
		<div style="display: flex;justify-content:space-between;margin-bottom:15px;" v-has="'sys:role:add'">
		...
		<mvk-table ref="mvkTable" :tableColumn="tableColumn" :tableDataFunc="tableDataFunc">
			...
			<el-table-column label="操作">
				<template slot-scope="{row}">
					<el-button type="text" size="small" @click="handleEdit(row)" v-has="'sys:role:edit'">编辑</el-button>
					<delete-button buttonType="text" size="small" @delete="handleDelete" :id="row.id" v-if="!row.internal" v-has="'sys:role:delete'">删除</delete-button>
				</template>
			</el-table-column>
		</mvk-table>
...
<script>
	import {roleList,deleteRole,searchRole} from 'api/basePage/role.js'
