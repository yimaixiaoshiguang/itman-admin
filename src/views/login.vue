				...
				<div class="login-form">
					...
					<el-form :model="loginForm" :rules="rules" ref="loginForm" label-position="top">
						...
						<el-form-item prop="principal" label="请输入您的账户">
							<el-input placeholder="请输入您的账户" v-model="loginForm.principal" v-enter-next-input size="large" clearable class="inputWidth">
								<icon-svg slot="prefix" icon="zhanghao" size="26" class="iconsvg"></icon-svg>
							</el-input>
						</el-form-item>
						<el-form-item prop="credentials" label="请输入您的密码" style="margin-bottom:76px">
							<el-input placeholder="请输入您的登录密码" v-model="loginForm.credentials" type="password" size="large" show-password @keyup.enter.native="loginSubmit('loginForm')" class="inputWidth">
								<icon-svg slot="prefix" icon="mima" size="26" class="iconsvg"></icon-svg>
							</el-input>

						</el-form-item>
						<el-form-item>
								<el-button type="primary" class="black-btn bg" @click="loginSubmit('loginForm')"  v-loading="loading">登录</el-button>
						</el-form-item>
					</el-form>
				</div>
